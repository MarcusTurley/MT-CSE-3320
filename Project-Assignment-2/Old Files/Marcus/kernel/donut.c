...
// canvas layout, 2x2
static const int xoff2x2[] = {0,NN/2,0,NN/2};
static const int yoff2x2[] = {0,0,NN/2,NN/2};

static const int xoff3x3[] = {
    0,NN*1/3,NN*2/3,
    0,NN*1/3,NN*2/3,
    0,NN*1/3,NN*2/3
};
static const int yoff3x3[] = {
    0,0,0,
    NN*1/3,NN*1/3,NN*1/3,
    NN*2/3,NN*2/3,NN*2/3
};
_Static_assert(N_DONUTS <= NELEM(xoff3x3));
...
void donut_pixel(int idx) {
    ...
    while (1) {
        ...
        int offsetx = xoff3x3[idx], offsety = yoff3x3[idx]; 
        int y = 0, x = 0;
